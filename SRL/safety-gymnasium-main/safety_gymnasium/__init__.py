...
# ----------------------------------------
# Safety Multi-Agent Variable MultiGoal (N agents -> N goals)
# ----------------------------------------
for _num_agents in [2, 3, 4, 5, 6, 8, 10]:
    __register_helper(
        env_id=f'SafetyAntMultiGoalN{_num_agents}-v0',
        entry_point='safety_gymnasium.tasks.safe_multi_agent.builder:Builder',
        spec_kwargs={
            'config': {
                'agent_name': 'Ant',
            ...
            'task_id': f'SafetyAntMultiGoalN{_num_agents}-v0',
        },
        max_episode_steps=1000,
        disable_env_checker=True,
    )
