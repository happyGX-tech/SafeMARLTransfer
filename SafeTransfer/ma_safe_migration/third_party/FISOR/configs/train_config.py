...
def get_config(config_string):
    ...
    base_data_config = dict(
        ...
        local_hdf5_path='', # Optional local offline dataset path for all envs
        num_agents=-1, # Optional explicit num_agents for CTCE local datasets
    )
    ...
    possible_structures = {
        ...
        "fisor_oracle": ConfigDict(
            dict(
                agent_kwargs=dict(
                    model_cls="FISOR",
                    oracle_cost_mode=True,
                    cost_limit=10,
                    actor_lr=3e-4,
                    critic_lr=3e-4,
                    value_lr=3e-4,
